...
# 
ArchiveURL := 
          Concatenation("http://web.mat.bham.ac.uk/~jamesa/mapclass/download/mapclass-",~.Version),
...
Persons := [
  rec( 
    ...
    WWWHome       := "http://www.mat.bham.ac.uk/~jamesa",
...
#
README_URL := 
  "http://web.mat.bham.ac.uk/~jamesa/mapclass/README",
PackageInfoURL := 
  "http://web.mat.bham.ac.uk/~jamesa/mapclass/PackageInfo.g",
