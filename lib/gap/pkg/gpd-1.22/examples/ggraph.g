...
Print( "\n===============================================================\n");
Print( "<<<< testing examples in the Gpd manual (version 24/01/13) >>>>\n" );
...
Display( gg3 );
f1 := GroupoidElement( Gfa, a^7, -1, -2);
f2 := GroupoidElement( Gfb, b^-6, -4, -4 );
f3 := GroupoidElement( Gfa, a^-11, -2, -1 );
f4 := GroupoidElement( Gfb, b^9, -3, -4 );
f5 := GroupoidElement( Gfa, a^7, -2, -1 ); 
