...
a78 := MultiplicativeElementWithObjects( M78, m2, -7, -8 ); 
Print( "a78 = ", a78, "\n" );
b87 := MultiplicativeElementWithObjects( M78, m4, -8, -7 ); 
Print( "b87 = ", b87, "\n" );
ba := b87*a78; 
ab := a78*b87;
...
t12 := MultiplicativeElementWithObjects( S123, t, -1, -2 ); 
s23 := MultiplicativeElementWithObjects( S123, s, -2, -3 ); 
r31 := MultiplicativeElementWithObjects( S123, r, -3, -1 ); 
ts13 := t12 * s23;
sr21 := s23 * r31;
rt32 := r31 * t12;
tsr1 := ts13 * r31;
...
p0 := GroupoidElement( D0, (1,2,3,4), 0, 0 ); 
q0 := GroupoidElement( D0, (1,3), 0, 0 ); 
