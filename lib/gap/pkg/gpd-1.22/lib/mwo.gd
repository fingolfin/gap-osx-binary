...
#O  MultiplicativeElementWithObjectsNC( <isgpdelt>, <elt>, <tail>, <head> ) 
## 
DeclareOperation( "MultiplicativeElementWithObjects", 
    [ IsMagmaWithObjects, IsMultiplicativeElement, IsScalar, IsScalar ] ); 
DeclareOperation( "MultiplicativeElementWithObjectsNC", 
    [ IsBool, IsMultiplicativeElement, IsScalar, IsScalar ] ); 
    
############################################################################## 
## 
#O  IsElementOfMagmaWithObjects( <e>, <mwo> ) 
##
##  this takes the place of an implementation of \in 
##  
DeclareOperation( "IsElementOfMagmaWithObjects", 
