...
DeclareOperation( "IdentityElement", [ IsGroupoid, IsScalar ] ); 
...
#############################################################################
##
#O  ConjugateGroupoidElement( <x>, <y> ) . . . . groupoid conjugate of x by y
## 
#?  can now change this to  e^g  ??
DeclareOperation( "ConjugateGroupoidElement", 
    [ IsGroupoidElement, IsGroupoidElement ] );
