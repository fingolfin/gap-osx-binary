...
##  KanBuildManual()
##
KanBuildManual:=function()
local kan_path, kan_main, kan_files, kan_bookname;
kan_path:=Concatenation(
               GAPInfo.PackagesInfo.("kan")[1].InstallationPath,"/doc/");
kan_main := "manual.xml";
kan_bookname:="Kan";
MakeGAPDocDoc( kan_path, kan_main, [ ], kan_bookname );;
end;
