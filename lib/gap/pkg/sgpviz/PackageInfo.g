...
# 
ArchiveURL := 
          "http://www.fc.up.pt/cmup/mdelgado/sgpviz/sgpviz-0.998",
...
#    WWWHome       := "",
    PostalAddress := Concatenation( [
                   ...
                   "Portugal" ] ),
    Place         := "Porto",
    Institution   := "Faculdade de Ciencias"
  )
...
#
README_URL := 
  "http://www.fc.up.pt/cmup/mdelgado/sgpviz/README",
PackageInfoURL := 
  "http://www.fc.up.pt/cmup/mdelgado/sgpviz/PackageInfo.g",
...
# utilities.",
AbstractHTML := 
   "The <span class=\"pkgname\">SgpViz</span> package, is a package with some visualization functions for semigroups.",

PackageWWWHome := "http://www.fc.up.pt/cmup/mdelgado/sgpviz",
...
Dependencies := rec(
  ...
  # NeededOtherPackages := [["GAPDoc", ">= 0.993"]],
  ...
  # ExternalConditions := []
  ExternalConditions := [["Evince","http://www.gnome.org/projects/evince/"],["Graphviz","http://www.graphviz.org/"],["Tcl/Tk","http://www.tcl.tk/"]]
