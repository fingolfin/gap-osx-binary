...
##  <!ENTITY VERSION "2.26">
##  <!ENTITY TARFILENAME "xmod-2.26.tar.gz">
##  <!ENTITY HTMLFILENAME "xmod226.html">
##  <!ENTITY RELEASEDATE "26/11/2013">
##  <!ENTITY LONGRELEASEDATE "26th November 2013">
##  <#/GAPDoc>

PackageWWWHome := 
  "http://www.math.bangor.ac.uk/chda/gap4/xmod/",

ArchiveURL := "http://www.math.bangor.ac.uk/chda/gap4/xmod/xmod-2.26", 
...
Dependencies := rec(
  GAP := ">=4.7",
  NeededOtherPackages := [ ["Gpd", ">= 1.22"], ["autpgrp", ">= 1.5"] ],
